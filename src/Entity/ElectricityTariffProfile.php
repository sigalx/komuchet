...
#[ORM\Entity(repositoryClass: ElectricityTariffProfileRepository::class)]
#[ORM\Table(name: 'electricity_tariff_profiles')]
#[ORM\UniqueConstraint(name: 'ux_electricity_tariff_profiles_workspace_uuid', columns: ['workspace_uuid', 'uuid'])]
#[ORM\UniqueConstraint(name: 'ux_electricity_tariff_profiles_code_active', columns: ['workspace_uuid', 'code'], options: ['where' => 'deleted_at IS NULL'])]
