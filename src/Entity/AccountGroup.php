...
#[ORM\UniqueConstraint(name: 'ux_account_groups_workspace_uuid', columns: ['workspace_uuid', 'uuid'])]
#[ORM\UniqueConstraint(name: 'ux_account_groups_code_active', columns: ['workspace_uuid', 'code'], options: ['where' => 'deleted_at IS NULL'])]
class AccountGroup
{
    #[ORM\Id]
